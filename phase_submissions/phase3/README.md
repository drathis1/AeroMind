...
| Rubric item | Path |
|---|---|
| Final artifact / code | `../../aeromind/`, `../../tests/` |
| Architecture diagram | `../../docs/architecture_diagram.png` |
| Final report | `../../docs/final_report.md` (export to PDF) |
| Screenshots (10) + index | `../../docs/screenshots/` |
| Evaluation package | `../../eval/` |
| Traces | `../../traces/` |
| README | `../../README.md` |
| AI usage | `../../AI_USAGE.md` |
| Video link | `../../media/demo_video_link.txt` |
| Phase 2 artifact | `../../Agentic Phase 2.docx` |
